      ...
      <div className="ki-info">
        ...
        <div className="info-container">
          <p className="info-box">
            ...
            Authorities who specialize in specific Torah laws).
          </p>
        </div>
        <div className="info-container">
          <p className="info-box">
        ...
        <div className="info-container">
          <p className="info-box">
            ...
            husband Reb Shmuel if there was a way to hook up some kind of
            bedside light so she could read in the bedroom on Shabbos.<br></br>
            ...
            totally darken the lamp. As Hashgacha (Providence) would have it,
            one of Reb Shmuel’s congregants, Moshe Orzech z"l, was in the
            lighting business. Reb Shmuel and Moshe began to create a prototype
            for this new type of lamp. After much experimentation, and testing,
            they were ready to start production of this new innovation, the
            KosherLamp.
          </p>
        </div>{" "}
        <div className="info-container">
          <p className="info-box">
            ...
            States started to carry it and then interest spread to Israel,
