...
const FridgeezCarousel = () => {
  ...
  const testimonials = [
    {
      text: "I love the Fridgeez! It's so convenient and easy to use.",
      author: "Dan",
    },
    {
      text: "The Fridgeez has really improved my Shabbos reading experience.",
      author: "Derek",
    },
    {
      text: "I love the sleek design of the Fridgeez. It's the perfect addition to my home.",
      author: "Rani",
    },
  ];
