...
const WarmTrayCarousel = () => {
  ...
  const testimonials = [
    {
      text: "I love the Shabbos Safe Warming Tray! It's so convenient and easy to use.",
      author: "Dan",
    },
    {
      text: "The Shabbos Safe Warming Tray has really improved my Shabbos reading experience.",
      author: "Derek",
    },
    {
      text: "I love the sleek design of the Shabbos Safe Warming Tray. It's the perfect addition to my home.",
      author: "Rani",
    },
  ];
